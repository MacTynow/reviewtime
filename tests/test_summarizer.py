...
class TestActivitySummarizer:
    ...
    def test_generate_summary_mock_mode(self):
        ...
        assert "performance optimization" in summaries["github"].lower() or "development work" in summaries["github"].lower()
        assert "team communications" in summaries["slack"].lower() or "discussions" in summaries["slack"].lower()
    ...
    def test_create_github_prompt(self):
        ...
        prompt = summarizer._create_github_prompt("test activities", "2024-01-01", "2024-01-07")
    ...
    def test_create_slack_prompt(self):
        ...
        prompt = summarizer._create_slack_prompt("test messages", "2024-01-01", "2024-01-07")
    ...
    def test_summarize_source_unknown_type(self):
        ...
        result = summarizer._summarize_source("unknown", activities, "2024-01-01", "2024-01-07")
